...
public class QuizMultipleChoiceScoreTest {
    ...
    public QuizMultipleChoiceScoreTest(double expected, ArrayList<Integer> buttonnumber, ArrayList<QuizItem> quiz) {
    ...
    public static Collection<Object[]> parameters() {
        ...
        test3.add(1);
        test3.add(1);
        return Arrays.asList(new Object[][]{{1.0, test1, setquiz}, {2.0, test2, setquiz}, {0.0, test3, setquiz}});
    }

    @Test
    public void testPrintScore() {
        quizAndBroadcastMain.multipleChoiceScore(buttonnumber, quiz);
        assertEquals(expected, quizAndBroadcastMain.getScore());
    }
